...
document.addEventListener('click', async e => {
    ...
    if (e.target.dataset.action === 'edit-home') {
        const homeItem = document.getElementById('admin-home-item');
        homeItem?.querySelectorAll('[disabled]').forEach(el => el.removeAttribute('disabled'));
        homeItem?.classList.add('is-editing');
        return;
    }
    ...
    if (e.target.dataset.action === 'add') {
        ...
        try {
            ...
            if (editorContainer) {
                ...
                const newAdminItem = editorContainer.querySelector('.admin-item');
                newAdminItem?.querySelectorAll('[disabled]').forEach(el => el.removeAttribute('disabled'));
                newAdminItem?.classList.add('is-editing');
    ...
    if (e.target.dataset.action === 'edit') {
        ...
        adminItem?.classList.add('is-editing');
        return;
    }
